...
public class SearchCollect {
    ...
    public SearchCollect() {
    }

    public SearchCollect(String gardenId, String gardenLocation, String gardenType, String collectId, String collectDate) {
